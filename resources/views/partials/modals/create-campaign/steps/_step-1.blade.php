...
<div class="current" data-kt-stepper-element="content">
	...
	<div class="w-100">
		...
		<div class="fv-row mb-10">
			...
			<style>.image-input-placeholder { background-image: url('{{ image("svg/files/blank-image.svg") }}'); } [data-bs-theme="dark"] .image-input-placeholder { background-image: url('{{ image("svg/files/blank-image-dark.svg") }}'); }</style>
