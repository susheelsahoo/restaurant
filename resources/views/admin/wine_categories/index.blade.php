    ...
    <div class="card">
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <input type="text" class="form-control form-control-solid w-250px" placeholder="Search wine Category">
            </div>
            <div class="card-toolbar">
                <a href="{{ route('admin.wine-categories.create') }}" class="btn btn-primary">
                    {!! getIcon('plus', 'fs-2', '', 'i') !!} Add wine Category
                </a>
            </div>
        </div>
