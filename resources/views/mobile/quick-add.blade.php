...
@section('mobile-content')
    <div class="quick-add-page">
        <header class="qa-topbar">
            <button class="qa-icon-btn" type="button" aria-label="Go back"
                onclick="window.location.href='{{ url('/mobile/dashboard') }}'">
        ...
        <main class="qa-main">
            ...
            <section class="qa-card">
                <div class="qa-action-row">
                    <button id="scanBtn" class="qa-action-btn qa-action-primary" type="button" aria-pressed="true">Scan
                        Product</button>
                    <button id="templateBtn" class="qa-action-btn qa-action-secondary" type="button"
                        aria-pressed="false">Templates</button>
                </div>
                ...
                <div class="qa-chip-row">
                    ...
                    @foreach ($quickAddCategories as $category)
                        <button class="qa-chip" type="button"
                ...
                <div class="qa-search-box">
                    ...
                    <input id="searchInput" type="text" placeholder="Search product name, SKU, barcode, category..."
                        aria-label="Search product name, SKU, barcode, or category">
                </div>
            </section>
            ...
            <div class="qa-section-head qa-list-head">
                <h2>Product List</h2>
                <button id="toggleProductListBtn" class="qa-list-toggle" type="button" aria-pressed="false">Hide product
                    list</button>
            </div>
            ...
            <section class="qa-product-list" id="productList">
                @foreach ($quickAddProducts as $product)
                    ...
                    @endphp
                    <article class="qa-product-item" data-id="{{ $product['id'] }}" data-name="{{ $product['name'] }}"
                        data-category="{{ strtolower($product['category']) }}" data-category-slug="{{ $categorySlug }}"
                        data-sku="{{ $product['sku'] }}" data-barcode="{{ $product['barcode'] }}"
                        data-supplier="{{ $product['preferred_supplier'] }}" data-unit="{{ $product['unit'] }}"
        ...
        <div class="qa-modal-overlay" id="orderModal" aria-hidden="true">
            <div class="qa-modal" role="dialog" aria-modal="true" aria-labelledby="orderModalTitle">
                <div class="qa-modal-head">
                    ...
                    <button class="qa-modal-close" id="closeOrderModalBtn" type="button"
                        aria-label="Close submit request">×</button>
                </div>
